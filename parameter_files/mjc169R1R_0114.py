...
#
# ONLY THIS SESSION:    nrem time stamps are missing --> for computations all SWR were used (+ speed filtering)
#                       --> to recompute results: use setting "all_swr" and rename decoded files to .nrem
#
########################################################################################################################
...
class SessionParameters():
    ...
    def __init__(self):
        ...
        self.goal_locations = [[193.238, 141.594], [274.633, 211.600],
                       [247.605, 78.6555], [126.712, 76.9746]]
        self.long_sleep_experiment_phases = ["sleep_long_1", "sleep_long_2", "sleep_long_3", "sleep_long_4",
                                             "sleep_long_5"]

        # learning cheeseboard 1
        # ------------------------------------------------------------------------------------------------------------------
        self.lcb_1_nr_trials_last_5_min = range(21, 29)
        self.lcb_1_nr_trials_last_10_min = range(14, 29)
        ...
        # --------------------------------------------------------------------------------------------------------------
        self.lcb_2_nr_trials_first_5_min = range(0, 8)
        self.lcb_2_nr_trials_first_10_min = range(0, 18)
        self.lcb_2_first_10_min_phmm_modes = 50
        self.lcb_2_first_10_min_phmm_modes_old = 35
        # which data to use by default
        ...
        self.sleep_compression_factor_12spikes_100ms = 0.65
        self.sleep_compression_factor_12spikes_100ms_stable_cells = 12
        self.sleep_compression_factor_12spikes_100ms_decreasing_cells = 0.92
        self.sleep_compression_factor_12spikes_100ms_increasing_cells = 0.63
        self.default_exp_fam_1_model = "mjc169R1R_0114_1_p1_51_modes"
        self.default_exp_fam_2_model = "mjc169R1R_0114_14_p1_46_modes"
        self.default_pre_phmm_model = "mjc169R1R_0114_5_p1_trials_14_28_55_modes"
        self.default_pre_phmm_model_stable = "mjc169R1R_0114_5_p1_trials_14_28_31_modes"
        self.default_pre_phmm_model_dec = "mjc169R1R_0114_5_p1_trials_14_28_51_modes"
        self.default_pre_phmm_model_inc = "mjc169R1R_0114_5_p1_trials_14_28_31_modes"
        self.default_post_phmm_model = "mjc169R1R_0114_11_p1_trials_0_17_50_modes"
        self.default_pre_ising_model = "mjc169R1R_0114_5_5cm_bins_p1_trials_14_28"
        self.default_post_ising_model = "mjc169R1R_0114_11_5cm_bins_p1_trials_0_17"
